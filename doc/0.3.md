...
To avoid some potential inconveniences which are explained below, it is recommended to install Beamer inside a virtual environment or Anaconda distribution if you are familiar with those.
