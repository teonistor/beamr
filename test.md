...
`theme`: Theme to use for the presentation. "Copenhagen" by default.

`scheme`: Colour scheme to use for the presentation. "beaver" by default.
...
`packages`: List of LaTeX packages. Contains the essential ones by default, more can be added to suit your needs.
